...
final class CaptureAliasPaymentRequestHandlerTest extends TestCase
{
    ...
    public function testInvoke_withNoCardSelected_throws(): void
    {
        $this->paymentRequestWithSelectedCard(null);
    ...
    public function testInvoke_withGatewayConfigMissingAccountId_throws(): void
    {
        $this->paymentRequestWithSelectedCard($this->savedCard(), gatewayConfig: null);
