...
final class SyliusOrderStateMutatorTest extends TestCase
{
    ...
    // -------------------------------------------------------------------------
    // apply() — known outcome, transition possible → transition applied to the last Payment
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // apply() — outcome with no Sylius transition yet → no-op, logged
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // apply() — transition not allowed by the current Payment state → logged, no throw
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // apply() — unknown order id or order with no payment → throws
    // -------------------------------------------------------------------------
