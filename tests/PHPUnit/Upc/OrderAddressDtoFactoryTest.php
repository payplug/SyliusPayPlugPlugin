...
final class OrderAddressDtoFactoryTest extends TestCase
{
    private OrderAddressDtoFactory $factory;

    protected function setUp(): void
    {
        $this->factory = new OrderAddressDtoFactory();
    }
    ...
    private function address(
        ...
        $address->method('getProvinceCode')->willReturn('75');
