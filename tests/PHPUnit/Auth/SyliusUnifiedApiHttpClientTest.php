...
final class SyliusUnifiedApiHttpClientTest extends TestCase
{
    ...
    // -------------------------------------------------------------------------
    // get() — delegates to HttpClientInterface with the given headers
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // postJson() — sends the body as JSON, not form-encoded
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // non-2xx status does not throw — AbstractUnifiedApiService checks it
    // -------------------------------------------------------------------------
