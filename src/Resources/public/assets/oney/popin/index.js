...
})({"6bzWq":[function(require,module,exports) {
...
var Popin = {
    ...
    storage: [],
    init: function() {
        if (typeof productMeta !== "undefined") Popin.watch();
        Popin.fade();
        Popin.closeHandler();
    },
    watch: function() {
        var _this = this, _loop = function(prop) {
            var _this1 = _this;
            var $selectors = $("[id*=".concat(_this.triggers[prop]));
            if ($selectors.length > 0) _this.handleProductOptionsChange($selectors, prop);
            productMeta[prop] = $selectors.val();
            $selectors.on("input", _this.debounce(function(e) {
                e.preventDefault();
                if ($selectors.length > 0) _this1.handleProductOptionsChange($selectors, prop);
                productMeta[prop] = $(e.currentTarget).val();
                _this1.check();
            }, 500));
        };
        for(var prop in this.triggers)_loop(prop);
   ...
   * @param $selectors
   * @param prop
   */ handleProductOptionsChange: function($selectors, prop) {
        if (prop === "option") {
            var selector = "";
   ...
   */ debounce: function(func, wait) {
        ...
        return function executedFunction() {
            ...
            var later = function() {
                ...
                func.apply(void 0, _helpers.toConsumableArray(args));
            };
            clearTimeout(timeout);
    ...
    fade: function() {
        ...
        $(this.handlers.info).on("click", function(e) {
            e.preventDefault();
            e.stopPropagation();
            if (!$(_this.handlers.popin).is(":empty") && $(_this.handlers.popin).text().trim() === _this.storage) {
                $(_this.handlers.popin).fadeIn();
                return;
            }
    ...
    load: function() {
        ...
        $.ajax({
            ...
            data: this.productMeta,
            success: function success(res) {
                if (res.includes(translations.reason)) $(self.handlers.popin).removeClass("enabled").addClass("disabled");
...
},{"@swc/helpers":"cKfRD"}],"cKfRD":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4CU7Z"}]},["6bzWq"], "6bzWq", "parcelRequireeafa")
